      ...
      {isLoading ? (
        ...
        <Box m="20px">
          ...
          {active && (
            ...
            >
              <Box className="absolute top-[35%] left-[35%] w-[450px] bg-white dark:bg-slate-900 rounded-[8px] shadow p-4 outline-none">
                ...
                <div className="mt-4">
                  ...
                  >
                    <option value="admin"className="dark:!bg-slate-900 dark:active:!bg-slate-600 dark:text-white text-black">Admin</option>
                    <option value="user"className="dark:!bg-slate-900 dark:active:!bg-slate-600 dark:text-white text-black">User</option>
                  </select>
                  <br />
                  <div
