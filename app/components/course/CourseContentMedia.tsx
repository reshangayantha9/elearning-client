...
const CourseContentMedia = ({
  ...
  const [addReplyReview,{isSuccess:replySuccess,error:replyError,isLoading:replyLoading}]=useAddReplyReviewMutation();
  useEffect(() => {
    if (isSuccess) {
      setQuestion("");
      refetch();
  ...
  const handleReviewReplySubmit=()=>{
    ...
    if(reply===""){
      ...
      addReplyReview({comment:reply,courseId:id,reviewId:reviewId})
    }
  }
    ...
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      ...
      {activeBar === 2 && (
        <>
          ...
          <br />
          <br />
          <div className="w-full h-[1px] bg-[#fffffff3b]"></div>
          <div>
            <CommentReply
              data={data}
                  ...
                  <div className="w-full my-5 dark:text-white text-black">
                    ...
                    {user.role === "admin" && (
                      <span
                        ...
                        onClick={() => {setIsReviewReply(!isReviewReply),setReviewId(item._id)}}
                      >
                        Add Reply
                      </span>
                    )}
